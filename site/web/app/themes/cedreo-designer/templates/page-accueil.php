...
<?php while (have_posts()) : the_post(); ?>
  ...
  <div class="section accesdirect">
    <nav class="no-bullet accesdirect--items">
      <a class="accesdirect--button" href="#why">
        ...
        <path d="M103.4 107h7.1v7.1h-7.1zm3.7-67.8C93.3 39.2 82 50.5 82 64.3h7.1c0-9.9 8.1-18 18-18s18 8.1 18 18-8.1 18-18 18h-3.7v21.1h7.1V89.2c12.2-1.7 21.7-12.2 21.7-24.8 0-13.9-11.2-25.2-25.1-25.2"/></svg>
        Pourquoi
      </a>
    ...
    <div class="row column">
      ...
      <ul class="row no-bullet pros--secteurs">
        <li class="columns large-3 medium-6 pros--secteur">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 100 100" class="pros--icon">
          ...
          <h3 class="pros--title">Bâtiment Neuf</h3>
        ...
        <li class="columns large-3 medium-6 pros--secteur">
          ...
          <h3 class="pros--title">Bâtiment Ancien</h3>
        ...
        <li class="columns large-3 medium-6 pros--secteur">
          ...
          <h3 class="pros--title">Agencement intérieur</h3>
        ...
        <li class="columns large-3 medium-6 pros--secteur">
          ...
          <h3 class="pros--title">Agencement extérieur</h3>
  ...
  <div class="section feature">
    ...
    <div class="feature--wrapper">
      <div class="feature--column"><img src="<?php echo get_template_directory_uri(); ?>/dist/images/img-dessiner.png" alt="Dessiner"></div>
